      ...
      categories: [
        {
          ...
          intro: "Tout ce qui touche le cash à mettre — minimum, maximum, sources créatives, exceptions.",
          items: [
            { title: "Le minimum de mise de fonds — calcul rapide", hook: "ET non ce n'est pas automatiquement 5%. Je te le calcule en 30 secondes top chrono." },
            ...
            { title: "Le CELIAPP — pourquoi déposer même si tu achètes bientôt", hook: "Tout le monde te dit « mets de l'argent dedans même si tu achètes la semaine prochaine ». Mais pourquoi ?" },
            { title: "Acheter sans mise de fonds — 3 situations possibles", hook: "Tu n'as pas beaucoup de liquidité ? Pas nécessairement bloqué. 3 situations te le permettent." },
            { title: "Acheter la maison de la famille sans mise de fonds", hook: "Ta grand-mère décide de te vendre LA maison. Tu n'as peut-être pas besoin de sortir un seul dollar." },
            { title: "Acheter une 2e propriété avec 5% — c'est possible", hook: "T'as déjà une maison, tu veux la garder et en acheter une autre… 5% impossible ? Faux." },
          ],
        },
        {
          id: "credit-dossier",
          eyebrow: "Crédit & dossier",
          intro: "Comment la banque lit ton dossier. Ce qui aide, ce qui nuit, ce qu'on peut corriger.",
          items: [
            { title: "Ta carte débit ne bâtit aucun crédit", hook: "T'es fier de jamais utiliser ta carte de crédit ? Félicitations… tu viens d'aider ton dossier de 0." },
            { title: "Buy Now Pay Later — le piège silencieux", hook: "Les Buy Now Pay Later, ça a l'air cute. Mais ton dossier, lui, paye tout de suite." },
            { title: "Ta cote de crédit : moins élevée que tu penses", hook: "Tu penses qu'il faut une cote parfaite pour acheter ? La réalité est beaucoup plus basse." },
            { title: "Faillite = plus jamais propriétaire ? Faux.", hook: "Tu as fait faillite et tu penses que c'est fini ? C'est complètement faux." },
            { title: "Pourquoi la banque préfère parfois une faillite à une proposition", hook: "Une faillite de 100 000 $ peut parfois être mieux vue qu'une proposition consommateur de 12 000 $." },
            { title: "Ta préqualification expire plus vite que tu penses", hook: "C'est connu, une préqualification a une date d'expiration. Mais ça arrive bien plus vite que tu crois." },
            { title: "Ta préqualification de 2025 est peut-être dépassée — vers le haut", hook: "De décembre à janvier, ta préqualification pourrait avoir augmenté." },
            { title: "Les 3 facteurs qui influencent ta capacité d'emprunt", hook: "Tu penses que tu ne qualifies pas ? 3 facteurs — et tout peut se corriger." },
          ],
        },
        {
          id: "revenus",
          eyebrow: "Revenus & profils particuliers",
          intro: "Pourboires, allocations, travailleurs autonomes, familles — la banque ne voit pas tout pareil.",
          items: [
            { title: "Le TIP — ton pourboire compte (autodéclaration)", hook: "Tu es serveuse, coiffeuse ou barman ? Ton pourboire peut compter. Je t'explique en 30 secondes." },
            { title: "Avoir des enfants & se qualifier", hook: "Tu as des enfants et tu penses que ça va te bloquer ? La réponse est oui… mais pas comme tu penses." },
            { title: "Tu gagnes 70 000 $ — combien tu peux acheter", hook: "Avec 70k de revenu, sans dettes importantes — voici le vrai chiffre." },
            { title: "Tu gagnes 100 000 $ — voici ton vrai pouvoir d'achat", hook: "Seul ou en couple à 100k. Voici les chiffres réels par région." },
            { title: "Les critères des banques — ce n'est pas toi, c'est elle", hook: "Une banque te refuse pour ce qu'une autre n'aurait jamais regardé." },
          ],
        },
        {
          id: "dettes-couts",
          eyebrow: "Dettes & coûts cachés",
          intro: "Auto, café, taxe de bienvenue — ce qui mange ton budget de maison sans que tu le voies.",
          items: [
            { title: "La Golf GTI vs ta maison", hook: "Tu veux une Golf GTI ? Parfait. Mais ça pourrait te coûter un garage." },
            { title: "Ton auto à 800 $/mois te coûte une maison", hook: "Aux yeux de la banque, ton 800 $ c'est une dette fixe. Voici l'impact réel." },
            { title: "Ton Starbucks quotidien te bloque-t-il vraiment ?", hook: "La banque ne regarde pas ton café. Mais l'ensemble peut tout changer." },
            { title: "Combien coûte la taxe de bienvenue ?", hook: "Tu viens d'acheter et tu te demandes la facture taxe de bienvenue ? On la calcule." },
          ],
        },
        {
          id: "strategies",
          eyebrow: "Stratégies & investissement",
          intro: "Faire travailler ta maison, monter un plex, garder les bons partenaires.",
          items: [
            { title: "Ta maison peut t'aider à acheter un plex", hook: "Tu penses que ta maison te tire dans le pied ? Ça pourrait être ton meilleur atout." },
            { title: "Acheter un triplex vs un quadruplex", hook: "À tes yeux c'est une porte de plus. Aux yeux de la banque, un monde de différence." },
            { title: "Pourquoi garder le même partenaire d'investissement au début", hook: "Changer de partenaires trop vite peut compliquer ton financement — et celui des autres." },
            { title: "Les maisons bi-générations — pourquoi tout le monde en parle", hook: "Les bi-générations, c'est rendu populaire. Et ce n'est pas un hasard." },
          ],
        },
        {
          id: "taux-refi",
          eyebrow: "Refinancement & taux",
          intro: "Quand casser, quand fixer, quand accélérer.",
          items: [
            { title: "Ton taux est au-dessus de 5 % ? Écoute bien.", hook: "Casser ton prêt peut parfois coûter MOINS que l'économie d'intérêts à venir." },
            { title: "Les paiements accélérés — sauver temps et intérêts", hook: "Diviser ton paiement en deux peut finir ton hypothèque 3 ans plus tôt." },
            { title: "Fixe, variable, hybride : que choisir en 2026", hook: "Pas de bonne ou mauvaise réponse universelle. Voici comment décider." },
          ],
        },
        {
          id: "lifestyle",
          eyebrow: "Storytelling & lifestyle",
          intro: "L'humain derrière le dossier. Anecdotes, mythes, bons coups.",
          items: [
            { title: "Girl Math ton hypothèque", hook: "Si on peut girl math un sac à 1 200 $, on peut DEFINITIVEMENT girl math une maison." },
            { title: "La commission du courtier — version charade", hook: "Je vaux cher mais je ne te coûte rien. Qui suis-je ?" },
            { title: "Les clients qui se marient pour acheter", hook: "Et après ils disent que les hommes ont peur de l'engagement…" },
          ],
        },
      ],
    },
      ...
      categories: [
        {
          ...
          intro: "Everything about the cash you put in — minimum, maximum, creative sources, exceptions.",
          items: [
            { title: "Minimum down payment — quick math", hook: "And no, it's not always 5%. Let me calculate it in 30 seconds top chrono." },
            ...
            { title: "The FHSA — why deposit even if you buy soon", hook: "Everyone tells you « put money in even if you buy next week ». But why ?" },
            { title: "Buying with no down payment — 3 possible situations", hook: "Low cash ? Not necessarily blocked. 3 situations let you buy anyway." },
            { title: "Buying the family home with no down payment", hook: "Your grandmother decides to sell you THE house. You may not need to pull a single dollar out." },
            { title: "Buying a 2nd property with 5% — it's possible", hook: "You already own a home, want to keep it AND buy another ? 5% impossible ? False." },
          ],
        },
        {
          id: "credit-file",
          eyebrow: "Credit & file",
          intro: "How the bank reads your file. What helps, what hurts, what we can fix.",
          items: [
            { title: "Your debit card builds zero credit", hook: "Proud you never use your credit card ? Congrats… you just helped your file by zero." },
            { title: "Buy Now Pay Later — the silent trap", hook: "BNPL looks cute. But your file pays right now." },
            { title: "Your credit score : lower than you think", hook: "Think you need a perfect score to buy ? Reality is much lower." },
            { title: "Bankruptcy = never an owner again ? False.", hook: "You filed bankruptcy and think it's over ? Completely false." },
            { title: "Why the bank sometimes prefers a $100k bankruptcy", hook: "A $100k bankruptcy can sometimes be viewed better than a $12k consumer proposal." },
            ...
            { title: "Your 2025 pre-qual may already be outdated — upward", hook: "From December to January, your pre-qual may have grown without you noticing." },
            { title: "The 3 factors that drive your borrowing capacity", hook: "Think you don't qualify ? 3 factors — and everything can be fixed." },
          ],
        },
        {
          id: "income",
          eyebrow: "Income & special profiles",
          intro: "Tips, child benefits, self-employed, families — the bank doesn't see them all the same.",
          items: [
            { title: "The TIP — your tips count (self-declaration)", hook: "Server, hairdresser, bartender ? Your tips can count. Let me explain in 30 seconds." },
            { title: "Having kids & qualifying", hook: "You have kids and think it'll block you ? Yes… but not how you think." },
            { title: "You earn $70k — how much can you buy", hook: "With $70k income, no major debts — here's the real number." },
            { title: "You earn $100k — your real buying power", hook: "Solo or as a couple at $100k. Real numbers by region." },
            { title: "Bank criteria — it's not you, it's them", hook: "One bank refuses you for what another wouldn't even check." },
          ],
        },
        {
          id: "debt-costs",
          eyebrow: "Debts & hidden costs",
          intro: "Car, coffee, welcome tax — what eats your home budget without you seeing it.",
          items: [
            { title: "The Golf GTI vs your house", hook: "Want a Golf GTI ? Fine. But it might cost you a garage." },
            { title: "Your $800/month car costs you a house", hook: "To the bank, that $800 is a fixed debt. Here's the real impact." },
            { title: "Is your daily Starbucks really blocking you ?", hook: "The bank doesn't see your coffee. But the whole picture might." },
            { title: "How much is the welcome tax ?", hook: "You bought and want to know the welcome tax bill ? Let's calculate." },
          ],
        },
        {
          id: "strategies",
          eyebrow: "Strategies & investment",
          intro: "Make your home work for you, build a plex, keep the right partners.",
          items: [
            { title: "Your house can help you buy a plex", hook: "Think your house holds you back ? It might be your best asset." },
            { title: "Buying a triplex vs a quadruplex", hook: "To you it's one more door. To the bank, a world of difference." },
            { title: "Why keep the same investment partner at the start", hook: "Switching partners too fast can hurt your financing — and theirs." },
            { title: "Bi-generational homes — why everyone's talking", hook: "Bi-generationals are now popular. And it's no accident." },
          ],
        },
        {
          id: "rate-refi",
          eyebrow: "Refinancing & rates",
          intro: "When to break, when to lock, when to accelerate.",
          items: [
            { title: "Your rate is above 5% ? Listen up.", hook: "Breaking your loan can sometimes cost LESS than the future interest savings." },
            { title: "Accelerated payments — save time & interest", hook: "Splitting your payment in two can finish your mortgage 3 years sooner." },
            { title: "Fixed, variable, hybrid : what to pick in 2026", hook: "No universal right answer. Here's how to decide." },
          ],
        },
        {
          id: "lifestyle",
          eyebrow: "Storytelling & lifestyle",
          intro: "The human behind the file. Anecdotes, myths, wins.",
          items: [
            { title: "Girl Math your mortgage", hook: "If we can girl math a $1,200 bag, we can DEFINITELY girl math a house." },
            { title: "Broker commission — riddle version", hook: "I'm worth a lot but cost you nothing. Who am I ?" },
            { title: "Clients who marry to buy", hook: "And then they say men fear commitment…" },
          ],
        },
      ],
    },
