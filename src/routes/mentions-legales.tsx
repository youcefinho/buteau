  ...
  return (
    <>
      ...
      <P>
        ...
        <strong>NEQ :</strong>{" "}
        {config.legal.neq || (
          <em className="text-[color:var(--color-bronze)]">
      ...
      <P>
        ...
        {config.amf.certificateNumberAndrew || (
          <em className="text-[color:var(--color-bronze)]">(à compléter — voir AMF.qc.ca)</em>
        )}
      </P>
  ...
  return (
    <>
      ...
      <P>
        ...
        <strong>NEQ:</strong>{" "}
        {config.legal.neq || (
          <em className="text-[color:var(--color-bronze)]">(Quebec business number — to be filled)</em>
        )}
      </P>
      ...
      <P>
        ...
        {config.amf.certificateNumberAndrew || (
          <em className="text-[color:var(--color-bronze)]">(to be filled — see lautorite.qc.ca)</em>
        )}
      </P>
      <AmfDisclaimer variant="card" className="my-6" />
