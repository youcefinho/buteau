...
/**
 * Page /lexique — version SSR-friendly du glossaire.
 *
 * Couvre :
 * - SEO crawlable (URLs uniques, h1+h2 hierarchy)
 * - Schema.org DefinedTermSet pour rich snippets dans la SERP
 * - Accessible meme sans JS
 *
 * Les 14 termes sont aussi accessibles dans la modal interactive
 * via le footer et eventuellement AutoGlossary inline (Phase 9 si besoin).
 */
...
function LexiquePage() {
  ...
  // Schema.org DefinedTermSet — JSON-LD inline pour SEO
  const definedTermSet = {
    "@context": "https://schema.org",
    "@type": "DefinedTermSet",
    "@id": isFr
      ? "https://equipe-buteau.intralysqc.workers.dev/lexique"
      : "https://equipe-buteau.intralysqc.workers.dev/lexique",
  ...
  return (
    ...
    >
      ...
      {/* JSON-LD Schema.org DefinedTermSet pour SEO */}
      <script
