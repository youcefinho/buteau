    ...
    >
      ...
      <Container size="md" className="relative py-32 md:py-40">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h1 className="font-signature text-[color:var(--color-cream)] text-3xl md:text-5xl lg:text-[3.25rem] leading-[1.1] tracking-[-0.01em] mb-6 animate-[buteauFadeUp_800ms_ease-out_300ms_both]">
            {t("notFound.title")}
          </h1>
          ...
          {/* Subtitle */}
          <p className="text-base md:text-lg text-[color:var(--color-cream)]/80 leading-[1.6] mb-12 max-w-xl mx-auto animate-[buteauFadeUp_700ms_ease-out_600ms_both]">
            {t("notFound.subtitle")}
          </p>
