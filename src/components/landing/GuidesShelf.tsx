...
export function GuidesShelf() {
  ...
  return (
    <section className="relative py-[clamp(4rem,9vw,8rem)] surface-cream overflow-hidden lined-paper">
      ...
      <span
        aria-hidden="true"
        className="absolute -top-12 right-0 font-[family-name:var(--font-editorial)]  text-[color:var(--color-taupe)]/8 text-[24rem] leading-none pointer-events-none select-none"
      >
        ¶
      </span>
                ...
                <li key={idx}>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 space-y-2">
                      ...
                      {/* Title */}
                      <h3 className="font-[family-name:var(--font-display)] font-bold text-[color:var(--color-navy-deep)] text-[clamp(1.125rem,1.6vw,1.25rem)] uppercase tracking-[0.02em] leading-snug group-hover:text-[color:var(--color-navy)] transition-colors text-balance">
                        {item.title}
                      </h3>
