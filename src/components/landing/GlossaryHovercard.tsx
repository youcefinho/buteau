  ...
  return (
    <>
      <span
        ...
        className="relative cursor-pointer underline decoration-[color:var(--color-bronze)] decoration-dotted underline-offset-[3px] decoration-[1.5px] hover:text-[color:var(--color-navy)] transition-colors"
      >
        {children}
      </span>
