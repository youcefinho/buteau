  ...
  return (
    <div className="mt-8 max-w-5xl mx-auto">
      ...
      <div className="text-center mb-7">
        <p className="font-[var(--font-editorial)] italic text-[color:var(--color-bronze-deep)] text-2xl md:text-3xl">
          ...
          <article className="group bg-[color:var(--color-cream-warm)] border border-[color:var(--color-taupe)]/40 p-6 md:p-7 transition-all duration-500 hover:border-[color:var(--color-bronze)]/70 relative overflow-hidden">
            ...
            <div className="flex items-start gap-3 mb-4 relative">
              <TrendingDown
                ...
                aria-hidden="true"
              />
              <h4 className="font-[var(--font-display)] font-bold text-[color:var(--color-navy-deep)] text-sm md:text-base uppercase tracking-[0.04em] leading-snug">
            ...
            <div className="grid grid-cols-2 gap-4 relative">
              <div>
                ...
                <p className="font-[var(--font-display)] font-extrabold text-[color:var(--color-bronze-deep)] text-2xl md:text-3xl tracking-[-0.01em] tabular-nums">
              ...
              <div className="border-l border-[color:var(--color-taupe)]/40 pl-4">
                ...
                <p className="font-[var(--font-display)] font-extrabold text-[color:var(--color-navy-deep)] text-2xl md:text-3xl tracking-[-0.01em] tabular-nums">
