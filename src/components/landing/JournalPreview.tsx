      ...
      <Container size="xl" className="relative">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-[clamp(2.5rem,5vw,4rem)]">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32 lg:self-start">
            <p className="eyebrow text-[color:var(--color-taupe-light)] inline-flex items-center gap-3 mb-5">
            ...
            <HeartbeatCta>
              <Link
                to="/journal"
                className="group inline-flex items-center gap-2 font-[var(--font-display)] text-sm font-semibold uppercase tracking-[var(--tracking-eyebrow)] text-[color:var(--color-taupe-light)] hover:text-[color:var(--color-cream)] transition-colors"
              >
          ...
          <div className="lg:col-span-7" style={{ perspective: "1500px" }}>
            <Tiltable maxDeg={2}>
              <article className="group relative bg-[color:var(--color-surface)] border border-[color:var(--color-taupe)]/40 hover:border-[color:var(--color-taupe-dark)]/70 transition-all duration-500 halo-glow overflow-hidden">
                ...
                <div className="absolute top-0 left-0 bottom-0 w-[100px] bg-[color:var(--color-cream-warm)] border-r border-[color:var(--color-taupe)]/30 hidden md:flex items-center justify-center pointer-events-none">
                  <span
                    aria-hidden="true"
                    className="font-[var(--font-editorial)] italic text-[color:var(--color-taupe-dark)] text-7xl leading-none"
                  >
                    01
                  </span>
                </div>
