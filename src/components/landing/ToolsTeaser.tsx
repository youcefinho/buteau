          ...
          {items.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-[family-name:var(--font-display)] font-bold text-[color:var(--color-cream)] text-[clamp(1rem,1.4vw,1.125rem)] uppercase tracking-[var(--tracking-eyebrow)] mb-2 leading-snug text-balance">
                  {item.title}
                </h3>
