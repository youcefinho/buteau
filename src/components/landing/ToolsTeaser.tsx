          ...
          {items.map((item, idx) => {
            ...
            return (
              <Link
                key={idx}
                to="/outils"
                className="group relative block bg-[color:var(--color-cream)]/8 backdrop-blur-sm border border-[color:var(--color-cream)]/20 p-[clamp(1.5rem,2.5vw,2rem)] text-center transition-all duration-500 hover:bg-[color:var(--color-cream)]/15 hover:border-[color:var(--color-taupe-dark)]/70 hover:-translate-y-1.5 overflow-hidden"
              >
                {/* Numéro Cormorant filigrane top-right */}
                <span
                  aria-hidden="true"
                  className="absolute top-3 right-4 italic text-[color:var(--color-taupe)]/25 text-3xl leading-none pointer-events-none select-none transition-colors duration-500 group-hover:text-[color:var(--color-taupe-dark)]/35"
                >
                  {String(idx + 1).padStart(2, "0")}
                </span>

                <div className="mb-5 flex justify-center text-[color:var(--color-taupe)] group-hover:text-[color:var(--color-taupe-light)] transition-colors">
                  <Icon size={36} strokeWidth={1.5} aria-hidden="true" />
                </div>
                <div className="w-8 h-px bg-[color:var(--color-taupe-dark)] mx-auto mb-4 transition-[width] duration-500 group-hover:w-14" />
