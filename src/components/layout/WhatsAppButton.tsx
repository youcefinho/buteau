...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span
        className="absolute inset-0 rounded-full bg-[color:var(--color-bronze)]/30 motion-safe:animate-ping pointer-events-none lg:group-hover:hidden"
        style={{ animationDuration: "2.4s" }}
        aria-hidden
      />
      <span
        className="absolute -inset-1 rounded-full bg-[color:var(--color-bronze)]/15 motion-safe:animate-ping pointer-events-none lg:group-hover:hidden"
        style={{ animationDuration: "2.4s", animationDelay: "0.6s" }}
        aria-hidden
      />

      {/* Icone WhatsApp dans badge bronze circulaire */}
